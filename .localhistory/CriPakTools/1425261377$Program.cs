    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                Console.WriteLine("CriPakTools.exe -e IN_FILE EXTRACT_ME - Extracts a file.\n");
                Console.WriteLine("CriPakTools.exe -e IN_FILE ALL - Extracts all files.\n");
                Console.WriteLine("CriPakTools.exe -r IN_FILE REPLACE_ME REPLACE_WITH [[REPLACE_ME_2 REPLACE_WITH_2] [REPLACE_ME_3 REPLACE_WITH_3]] - Replaces all REPLACE_ME files with their respective REPLACE_WITH files. (if there is an odd number then the last REPLACE_ME is ignored)\n");
                return;
            }
