    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                Console.WriteLine("CriPakTools.exe IN_FILE index INDEX_FILE - Indexes the archive");
                return;
            }

            string cpk_name = args[1];
            ...
            if (args[1].ToUpper() == "EXTRACT" && args.Length >= 3)
            {
            ...
            else if (args.Length >= 4 && args[1].ToUpper() == "REPLACE")
            {
                //if (args.Length < 3)
                //{
